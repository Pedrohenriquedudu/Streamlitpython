    ...
    class Ativação_SWT_Router:
        ...
        def mostrar(self):
            ...
            def formulario():
                ...
                Jumper_Central = st.text_input('Jumper_Central:')

                Tipo_cordão  = st.text_input('Tipo_cordão:')

                Metragem = st.text_input('Metragem:')

                Equipamento_Central = st.text_input('Equipamento_Central:')
                ...
                IP_SWT = st.text_input('IP_SWT:')

                Instalou_SFP = st.text_input('Instalou_SFP?')

                Modelo_SFP = st.text_input('Modelo_SFP?')
                ...
                if st.button('Gerar Carimbo'):
                    ...
                    st.success('Carimbo Gerado com Sucesso!')
                    exibir_respostas(Osx,ID_vantive,Técnico,Telefone,RE,Ciente,Tel,Jumper_Central,Tipo_cordão,Metragem,Equipamento_Central,Hostname,Andar,Fila,Bastidor,Slot,Porta,Switch_Cliente,IP_SWT,Instalou_SFP,Modelo_SFP,Roteador,Serie,Observação,Analista_ESSE)
            def exibir_respostas(Osx,ID_vantive,Técnico,Telefone,RE,Ciente,Tel,Jumper_Central,Tipo_cordão,Metragem,Equipamento_Central,Hostname,Andar,Fila,Bastidor,Slot,Porta,Switch_Cliente,IP_SWT,Instalou_SFP,Modelo_SFP,Roteador,Serie,Observação,Analista_ESSE):
                ...
                st.write(f'Jumper_Central: {Jumper_Central}')

                st.write(f'Tipo_cordão: {Tipo_cordão}')

                st.write(f'Metragem: {Metragem}')

                st.write(f'Equipamento_Central: {Equipamento_Central}')

                st.write(f'Hostname: {Hostname}')

                st.write(f'Andar: {Andar}')
                
                st.write(f'Fila: {Fila}')

                st.write(f'Bastidor: {Bastidor}')

                st.write(f'Slot: {Slot}')

                st.write(f'Porta: {Porta}')

                st.write(f'Switch_Cliente: {Switch_Cliente}')

                st.write(f'IP_SWT: {IP_SWT}')

                st.write(f'Instalou_SFP: {Instalou_SFP}')

                st.write(f'Modelo_SFP: {Modelo_SFP}')
